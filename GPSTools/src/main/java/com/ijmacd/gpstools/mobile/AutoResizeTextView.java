...
public class AutoResizeTextView extends TextView {
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            mMinTextSize = attributes.getFloat(R.styleable.AutoResizeTextView_minTextSize, MIN_TEXT_SIZE);
            mMaxTextSize = attributes.getFloat(R.styleable.AutoResizeTextView_maxTextSize, 0);
        }
        finally {
            attributes.recycle();
        }
...
//        return layout.getWidth();
        return (int)paint.measureText(source.toString());
    }
}